...
Generated for simulation: backtest_20250915_184824_d518d4f9
"""
...
class MyportolioETHMomentum(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.parameters = {'strategy_type': 'eth_momentum', 'kelly_fraction': 0.15, 'max_volatility': 0.3, 'max_drawdown': 0.15, 'var_limit_1day': 0.06, 'rebalance_frequency': 'daily', 'lookback_period': 30, 'momentum_threshold': 0.02}
