...
"""
Myportolio LEAN Algorithm - MyportolioMultiCrypto
Generated for simulation: backtest_20250915_195014_fe971d04
"""
...
class MyportolioMultiCrypto(QCAlgorithm):
    """
    ...
    def Initialize(self):
        ...
        self.parameters = {'strategy_type': 'dual_crypto', 'eth_allocation': 0.6, 'btc_allocation': 0.4, 'kelly_fraction': 0.167, 'correlation_threshold': 0.7, 'rebalance_frequency': 'daily', 'momentum_lookback': 20, 'risk_lookback': 30}
