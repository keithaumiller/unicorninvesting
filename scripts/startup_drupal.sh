...
MYSQL_SERVICE="mysql"
DRUPAL_URL="https://solid-acorn-gw6xx47pqxfv99p-80.app.github.dev/"
DRUPAL_UNICORN_URL="https://solid-acorn-gw6xx47pqxfv99p-80.app.github.dev/admin/metrics"
...
main() {
    ...
    echo -e "   🏠 Homepage: $DRUPAL_URL"
    echo -e "   📊 Dashboard: $DRUPAL_UNICORN_URL"
    echo ""
